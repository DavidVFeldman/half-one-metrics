...
Throughout, computations are exact unless stated otherwise; the scripts are deposited with
this paper.

Much of the paper is formally verified. A Lean~4 development accompanying this article
(\texttt{HalfOne}, deposited with the paper) proves, over $\mathbb Q$ and from a
