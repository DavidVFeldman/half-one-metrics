...
\begin{document}
\maketitle
\let\thefootnote\relax\footnotetext{\textit{2020 Mathematics Subject
Classification.} Primary 52B12; Secondary 52B05, 05C22, 05C80, 60C05, 68V20.\\
\textit{Key words and phrases.} Metric cone, metric body, extreme points, half-one
metrics, random graphs, formal verification, Lean~4.}
...
exterior angle. A range stopping at $n=10$ sees none of this; such a range has been read
as evidence against the trend.
...
and every script behind the tables are archived on Zenodo at
\href{https://doi.org/10.5281/zenodo.21953234}{\nolinkurl{doi:10.5281/zenodo.21953234}},
with the development repository at
\href{https://github.com/DavidVFeldman/half-one-metrics}{\nolinkurl{github.com/DavidVFeldman/half-one-metrics}}.
...
reproved: the formal census counts graphs satisfying the combinatorial predicate. In
...
A reduction: the total angle carried by non-half-one vertices is at most
